...
@Entity
@Table(name = "employee")
@NamedNativeQueries({ @NamedNativeQuery(name = "employeeEntity.fetchPracticeHeadsBySkill", query = "CALL fetchPracticeHeadsBySkill(:skillId)", resultClass = UserEntity.class),
		@NamedNativeQuery(name = "employeeEntity.fetchAllPracticeHeads", query = "CALL fetchAllPracticeHeads(:employeeId,:employeeName)", resultClass = EmployeeEntity.class) })
