...
public class EmailUtil {
	...
	public void sendSSLEmail() {
		...
		final String toEmail = "rasool1988@gmail.com"; // can be any
																	// email id
	...
	public static void sendAttachmentEmail(Session session, String toEmail, String subject, String body) {
		try {
			...
			msg.setReplyTo(InternetAddress.parse("rasool1988@gmail.com", false));
	...
	public static void sendImageEmail(Session session, String toEmail, String subject, String body) {
		try {
			...
			msg.setReplyTo(InternetAddress.parse("rasool1988@gmail.com.com", false));
